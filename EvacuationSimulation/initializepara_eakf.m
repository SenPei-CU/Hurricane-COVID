...
%Z,D,mu,theta,alpha,beta1,...,beta3142
paramin=[Zlow;Dlow;mulow;thetalow;alphalow;ones(num_loc,1)*betalow];
paramax=[Zup;Dup;muup;thetaup;alphaup;ones(num_loc,1)*betaup];
